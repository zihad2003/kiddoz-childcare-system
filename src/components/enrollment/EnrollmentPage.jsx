...
// Move sub-components outside to prevent re-mounting on every state update
const PlanSelection = ({ PLANS, handlePlanSelect }) => (
...
const StudentInfo = ({ navigate, selectedPlan, childData, setChildData, handleStudentInfoSubmit }) => {
  return (
  ...
  return (
    <div className="bg-slate-50 min-h-screen pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <Routes>
          <Route path="/" element={<PlanSelection PLANS={PLANS} handlePlanSelect={handlePlanSelect} />} />
          <Route path="kidsinfo" element={<StudentInfo navigate={navigate} selectedPlan={selectedPlan} childData={childData} setChildData={setChildData} handleStudentInfoSubmit={handleStudentInfoSubmit} />} />
          <Route path="AIsetup" element={<BiometricRegistration onComplete={handleBiometricComplete} onBack={() => navigate('/enroll/kidsinfo', { state: { plan: selectedPlan, childData } })} />} />
          <Route path="success" element={<SuccessView navigate={navigate} />} />
        </Routes>
      </div>
    </div>
  );
