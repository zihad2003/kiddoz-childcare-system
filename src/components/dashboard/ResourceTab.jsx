    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Badge color="bg-purple-100 text-purple-700">New Content Weekly</Badge>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
                {RESOURCES.map((resource, i) => (
                    <Card key={i} className="group hover:shadow-lg transition-all duration-300 border-l-4 border-l-purple-500 cursor-pointer">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <h3 className="font-bold text-lg text-slate-800 mb-2 group-hover:text-purple-600 transition-colors">{resource.title}</h3>
            ...
            <Card className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white border-0 mt-8 p-8 relative overflow-hidden">
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="text-center md:text-left">
                        <h3 className="text-2xl font-bold mb-2">Need a specific guide?</h3>
                        <p className="text-indigo-100">Ask our AI Assistant to find resources for you.</p>
                    </div>
                    <button className="bg-white text-indigo-600 px-6 py-3 rounded-xl font-bold hover:bg-indigo-50 transition shadow-lg">
                        Ask AI Assistant
                    </button>
                </div>
