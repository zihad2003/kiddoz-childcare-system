    ...
    <Card className="w-full max-w-md p-8 relative z-10 animate-in fade-in zoom-in duration-500 shadow-2xl">
      ...
      <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            onClick={async () => { await signInAnonymously(auth); setView('dashboard'); }}
          ...
          <button
            onClick={async () => { await signInAnonymously(auth); setView('admin'); }}
      ...
      <div className="pt-6 text-center">
        <button onClick={() => setView('home')} className="text-slate-400 hover:text-purple-600 font-bold transition flex items-center justify-center gap-2 mx-auto text-sm">
