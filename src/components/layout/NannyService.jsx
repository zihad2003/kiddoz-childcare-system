...
const NannyService = () => {
    return (
        <div className="w-full bg-purple-50 relative overflow-hidden">
            <Section id="nanny-service" className="py-24">
                {/* Decorative background elements */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-purple-100 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-pink-100 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000"></div>
                ...
                <div className="relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="lg:w-1/2">
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full text-purple-600 font-semibold text-sm shadow-sm mb-6 border border-purple-100">
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
                                ...
                                <span className="text-purple-600">Right at Your Doorstep</span>
                            </h2>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link
                                    to="/book-nanny"
                                    className="px-8 py-4 bg-purple-600 text-white font-bold rounded-xl shadow-lg hover:bg-purple-700 hover:shadow-purple-200 hover:-translate-y-1 transition-all duration-300 text-center"
                                >
                                    Book a Nanny
                                </Link>
                                <Link
                        ...
                        <div className="lg:w-1/2 relative">
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white transform rotate-2 hover:rotate-0 transition duration-500">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-8">
                                    ...
                                    <div className="flex -space-x-2 mt-2">
                                        ...
                                        <div className="w-8 h-8 rounded-full bg-pink-400 border-2 border-white flex items-center justify-center text-xs text-white font-bold">AS</div>
                            ...
                            {/* Floating Card */}
                            <div className="absolute -bottom-8 -left-8 bg-white p-4 rounded-xl shadow-xl border border-purple-50 animate-bounce-slow hidden md:block">
