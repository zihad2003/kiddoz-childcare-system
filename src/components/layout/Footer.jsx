...
const Footer = () => (
  <footer className="bg-primary-950 text-primary-200 py-16 font-sans">
    <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-12 mb-12">
      <div>
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 bg-primary-600 rounded-xl flex items-center justify-center font-bold text-xl text-white">K</div>
          <h3 className="text-3xl font-bold text-white leading-none">KiddoZ</h3>
        </div>
        <p className="text-primary-200/80 leading-relaxed mb-6">We are a modern childcare ecosystem dedicated to making early education safer and smarter through the power of AI.</p>
      ...
      <div>
        ...
        <ul className="space-y-4">
          <li><Link to="/programs/preschool" className="hover:text-secondary-400 transition text-left block">Pre-School (3-5 Yrs)</Link></li>
          <li><Link to="/programs/daycare" className="hover:text-secondary-400 transition text-left block">Day Care (6mo-3 Yrs)</Link></li>
          <li><Link to="/programs/nanny" className="hover:text-secondary-400 transition text-left block">Nanny Service</Link></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-4">
          <li className="flex items-start gap-3">
            <MapPin size={24} className="mt-1 text-secondary-400 shrink-0" />
            <span className="opacity-90 text-sm">Room No 529<br />UIU Playground, Madani Avenue<br />Dhaka, Bangladesh</span>
          </li>
          <li className="flex items-center gap-3">
            <MessageCircle size={20} className="text-secondary-400 shrink-0" />
            <a href="mailto:hello@kiddoz.com" className="hover:text-white transition text-sm">hello@kiddoz.com</a>
          </li>
          <li className="flex items-center gap-3">
            <Calendar size={20} className="text-secondary-400 shrink-0" />
            <span className="opacity-90 text-sm">Mon - Fri: 8:00 AM - 6:00 PM</span>
          </li>
        </ul>
      </div>
    </div>
    <div className="max-w-7xl mx-auto px-4 pt-8 border-t border-primary-900 flex flex-col md:flex-row justify-between items-center text-sm text-primary-400">
